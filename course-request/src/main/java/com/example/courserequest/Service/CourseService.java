package com.example.courserequest.Service;

import com.example.courserequest.model.Course;
...
//                UserBook.class);
        return restTemplate.exchange("http://course-info-service/book/info/detail/" + id,
                HttpMethod.GET, entity, Course.class).getBody();
    }

    public Course getCourseByIdFallback(Long id) {
